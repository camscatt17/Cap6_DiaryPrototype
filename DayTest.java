...
public class DayTest extends junit.framework.TestCase
{
    ...
    {
        day1 = new Day(1);
        appointm1 = new Appointment("teste", 1);
    }
    ...
    {
        Appointment appointm2 = new Appointment("ver mozao", 1);
        assertEquals(true, day1.makeAppointment(9, appointm1));
        assertEquals(10, day1.findSpace(appointm2));
    }

    public void testFindSpaceWithoutSpace()
    {
        assertEquals(true, day1.makeAppointment(9, appointm1));
        assertEquals(true, day1.makeAppointment(10, appointm1));
        assertEquals(true, day1.makeAppointment(11, appointm1));
        assertEquals(true, day1.makeAppointment(12, appointm1));
        assertEquals(true, day1.makeAppointment(13, appointm1));
        assertEquals(true, day1.makeAppointment(14, appointm1));
        assertEquals(true, day1.makeAppointment(15, appointm1));
        assertEquals(true, day1.makeAppointment(16, appointm1));
        assertEquals(true, day1.makeAppointment(17, appointm1));
        assertEquals(-1, day1.findSpace(appointm1));
    }

    public void testNegativeTest()
    {
        Appointment appointm2 = new Appointment("teste", 2);
        assertEquals(true, day1.makeAppointment(10, appointm1));
        assertEquals(false, day1.makeAppointment(9, appointm2));
    }
    ...
    {
        assertEquals(false, day1.makeAppointment(8, appointm1));
        assertEquals(false, day1.makeAppointment(18, appointm1));
    }

    public void test2hAppointments()
    {
        Appointment appointm2 = new Appointment("teste", 2);
        assertEquals(true, day1.makeAppointment(10, appointm1));
        assertEquals(false, day1.makeAppointment(9, appointm2));
        assertEquals(false, day1.makeAppointment(17, appointm2));
    }
}
